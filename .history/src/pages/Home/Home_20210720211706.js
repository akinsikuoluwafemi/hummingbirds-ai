		...
		<div>
			...
			<VideoLayer>
				<div className="container-fluid">
					...
					<div style={{height: '3rem', width: '100%', background: 'teal', textAlign: 'right', marginTop: '2rem'}}>1</div>

					<img style={{ position: 'absolute', top: '5%', left: '60%', height: '2.5rem', cursor: 'pointer' }} className="logo" src={HummingBirdLogo} alt="HummingBirdLogo" />
